...
public class DeviceList extends AppCompatActivity {
    ...
    //private static final UUID MY_UUID =
            //UUID.fromString("00001101-0000-1000-8000-00805F9B34FB"); //TODO
    private static final UUID MY_UUID =
            UUID.fromString("8ce255c0-223a-11e0-ac64-0803450c9a66"); //TODO

    //ConnectedThread managerThread;
    ...
    /*private void connectDevice(int position) {
        Toast.makeText(DeviceList.this,"Conneting to: "  +discoveredList.get(position).getName(),Toast.LENGTH_LONG).show();
        ConnectThread cThread = new ConnectThread(discoveredList.get(position));
        cThread.start();
    }*/
